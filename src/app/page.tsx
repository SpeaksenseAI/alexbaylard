        ...
        <section id="headshots" className="w-full py-24 bg-white dark:bg-zinc-900 border-y dark:border-zinc-800">
          <div className="container mx-auto px-4 md:px-8 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {[1, 2, 3].map((i, index) => (
                <FadeIn key={i} direction="up" delay={index * 0.1}>
                  <div className="aspect-[4/5] bg-zinc-100 dark:bg-zinc-800 rounded-xl flex flex-col items-center justify-center text-zinc-400 border-2 border-dashed border-zinc-200 dark:border-zinc-700 overflow-hidden relative group">
        ...
        <section id="bio" className="w-full py-24 bg-white dark:bg-zinc-900">
          <div className="container mx-auto px-4 md:px-8">
            <div className="grid md:grid-cols-12 gap-12 items-center">
              <FadeIn direction="right" className="md:col-span-5">
                <div className="aspect-[3/4] bg-zinc-200 dark:bg-zinc-800 rounded-2xl overflow-hidden relative border-2 border-dashed border-zinc-300 dark:border-zinc-700 flex flex-col items-center justify-center text-zinc-400">
                  <ImageIcon className="w-12 h-12 mb-4 opacity-50" />
                  <p className="font-medium text-center px-4">[PLACEHOLDER: Candid/Lifestyle or Secondary Headshot]</p>
                </div>
              </FadeIn>
              <FadeIn direction="left" delay={0.2} className="md:col-span-7 space-y-6">
